 ...
 * @author shaur
 */
public class ManageOrgAdmin extends javax.swing.JPanel {
...
//    Employee employee;
	 ...
	 */
	public ManageOrgAdmin(JPanel userProcessContainer, Enterprise enterprise, EcoSystem system) {
		initComponents();
...
//        this.organizationDirectory = organizationDirectory;
	...
	public void resetFields() {
		TFCleaningEmployeeUname.setText("");
	}
	...
	private void populateOrganizationComboBox() {
		...
		for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
			BoxCleaningOrg.addItem(organization);
	...
	private void populateTable() {
		...
		for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
			if (organization instanceof CleaningInterior || organization instanceof CleaningExterior) {
	...
	private void initComponents() {
		...
		TFCleaningEmployeePass = new javax.swing.JTextField();
		ButtonAddOrgAdmin = new javax.swing.JButton();
		jLabel5 = new javax.swing.JLabel();
		jLabel6 = new javax.swing.JLabel();
		TFCleaningEmployeeUname = new javax.swing.JTextField();
		...
		add(TFCleaningEmployeePass, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 320, 140, -1));
		...
		add(TFCleaningEmployeeUname, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 290, 140, -1));
		...
		add(BoxRole, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 250, 150, -1));

		BoxCleaningOrg.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
		BoxCleaningOrg.setForeground(new java.awt.Color(25, 56, 82));
		BoxCleaningOrg.setModel(
				new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
		BoxCleaningOrg.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				if (Objects.nonNull(BoxCleaningOrg.getSelectedItem())) {
					populateRoleComboBox((Organization) BoxCleaningOrg.getSelectedItem());
				}
			}
		});
		add(BoxCleaningOrg, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 220, 150, -1));
	...
	private void ButtonAddOrgAdminActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_ButtonAddOrgAdminActionPerformed
		...
		String userName = TFCleaningEmployeeUname.getText();
		String password = TFCleaningEmployeePass.getText();
		if ("".equals(userName)) {
			...
			Organization organization = (Organization) BoxCleaningOrg.getSelectedItem();
			...
			TFCleaningEmployeeUname.setText("");
			TFCleaningEmployeePass.setText("");
		}
...
//		Organization organization = (Organization) BoxRole.getSelectedItem();
...
//		}
	...
	private void BoxCleaningOrgActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BoxCleaningOrgActionPerformed
		// TODO add your handling code here:
	}// GEN-LAST:event_BoxCleaningOrgActionPerformed

	// Variables declaration - do not modify//GEN-BEGIN:variables
	private javax.swing.JComboBox BoxCleaningOrg;
	private javax.swing.JComboBox BoxRole;
	private javax.swing.JButton ButtonAddOrgAdmin;
	private javax.swing.JTextField TFCleaningEmployeePass;
	private javax.swing.JTextField TFCleaningEmployeeUname;
